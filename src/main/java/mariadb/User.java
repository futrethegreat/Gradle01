...
public class User {
  ...
  /**
   * Constructor: Creates an User object using parameters userID, userName, borrowedBooks
   * 
   * @author DavidSauce
   * @version 11-03-2018
   * @param userID
  ...
  /**
   * Constructor: Gets User data from DB with pUserID and creates an User object with DB data.
   * 
   * @author DavidSauce
   * @version 11-03-2018
   * @param pConnection
  ...
  /**
   * Constructor: Gets User data from DB with pUserName and creates an User object with DB data.
   * 
   * @author DavidSauce
   * @version 11-03-2018
   * @param pConnection
  ...
  public int setBorrowedBooks(Connection pConnection) throws SQLException {
    PreparedStatement s = pConnection
        .prepareStatement("UPDATE users SET BorrowedBooks = ? WHERE UserID = ?");
  ...
  /**
   * Borrows a book to an users. Set Book.Lent=True, increase User.BorrowedBook and creates record
   * in Loans table.
   * 
   * @author DavidSauce
   * @version 11-03-2018
  ...
  public boolean borrowBook(Connection pConnection, Book b) throws SQLException {
    if (b.isLent()) {
      System.out.println("INFO: Book \"" + b.getBookTitle() + "\" is not available to lent.");
      return false;
    }
  ...
  /**
   * Returns a book to the library. Set Book.Lent=False, decrease User.BorrowedBook and deletes
   * record in Loans table.
   * 
   * @author DavidSauce
   * @version 11-03-2018
   * @param b
